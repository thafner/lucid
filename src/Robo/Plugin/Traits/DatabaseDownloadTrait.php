...
trait DatabaseDownloadTrait {
  ...
  public function databaseDownload(string $site_name, string $bucket, string $directory, string $file, ConsoleIO $io): string|Result|ResultData
  {
   ...
   */
  protected function configureAwsCredentials(string $awsConfigDirPath, string $awsConfigFilePath, ConsoleIO $io): Result|ResultData
  {
